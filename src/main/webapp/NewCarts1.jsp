...
<div class="container-fluid">
 ...
 <div class="row" style="height:470px;">
	...
	%>
		...
		<img  id="images" src="MyPhotos/<%= prodArr[4]%>"  alt="product1" style="height:250px; padding:5px 10px 5px 10px;" />					
			<h6 class="text-center">Price: &#8377;<%= prodArr[3]%></h6>
				...
				<h6 class="text-center p-2"><span class="badge bg-success">4.4 <ion-icon name="star-half-outline"></ion-icon></span></h6>
					...
					<form action="addServlet" method="get" class="text-center">
					<div class="btn-group d-flex">
						<a  class="btn btn-warning flex-fill" href="addServlet?productId=<%=Integer.parseInt(prodArr[0])%>">ADDTOCART</a><a target="_blank" class="btn btn-success flex-fill" href="buyNow?productId=<%=Integer.parseInt(prodArr[0])%>">BUYNOW</a>
					</div>
					</form>
